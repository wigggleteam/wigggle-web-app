...
import { Grid, Icon, Step, Form, Input, TextArea, Button, Radio, Checkbox } from 'semantic-ui-react';
        ...
        <Form.Field>
          <label>Guest Rules / Amenities </label>
          {
            _.map(amenitiesConstant, (value) => {
              return (
                <>
                <Checkbox label={value.label} name={value.key} checked={amenities.indexOf(value.key) > -1} onChange={handleAmenities}/> <br />
                </>
              )
            })
          }
